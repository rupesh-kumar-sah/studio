...
export function AdminProductPageClient({ initialProducts }: { initialProducts: Product[] }) {
  ...
  useEffect(() => {
    // Products are passed as a prop, but we still might want to re-fetch on client
    // if a product is updated.
